...
import { Award, Eye, Target, Handshake, Instagram, Mail, MessageCircle } from "lucide-react";
        ...
        <div className="container-pw grid lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            <div className="relative">
              ...
              <img src={founder} alt="Marcus Derrick" className="relative rounded-2xl shadow-2xl border-2 border-gold/20" />
            </div>
          </ScrollReveal>
          <ScrollReveal delay={150}>
            <span className="label-accent">Meet the Founder</span>
            <h2 className="text-3xl md:text-4xl mt-3 text-navy">Marcus Derrick</h2>
            <p className="text-gold font-semibold mt-1">Founder · UI/UX Designer & Web Developer</p>
            <p className="mt-5 text-muted-foreground">With 5+ years building digital products for businesses across Canada, the US, Australia, Singapore and beyond, Marcus founded Prime Wave to deliver the kind of premium, results-focused work clients can't find elsewhere — without the bloated agency price tag.</p>
            <div className="flex gap-3 mt-6">
              <a href="https://wa.me/12268556194" target="_blank" rel="noopener" className="w-10 h-10 rounded-full bg-navy text-white flex items-center justify-center hover:bg-gold transition"><MessageCircle size={18} /></a>
